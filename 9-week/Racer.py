...
background_image = pygame.image.load('Street.png')
enemy_image = pygame.image.load('Enemy.png')
player_image = pygame.image.load('Player.png')
coin_image_L1 = pygame.image.load('1.png')
coin_image_L2 = pygame.image.load('2.png')
coin_image_L3 = pygame.image.load('3.png')
